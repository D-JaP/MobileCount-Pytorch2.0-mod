...
def print_summary(exp_name, scores, train_record):
    ...
    print('    '+ '-'*20)
    print('[best] [model: %s] , [mae %.2f], [mse %.2f]' % (train_record['best_model_name'], train_record['best_mae'], train_record['best_mse']))
    print('='*50)
...
def print_GCC_summary(log_txt,epoch, scores,train_record,c_maes,c_mses):
    ...
    print('='*50)
    print('    '+'-'*20)
    print('    [mae {:.2f} mse {:.2f}], [val loss {:.4f}]'.format(mae, mse, loss))
    print('    '+'-'*20)
    print('[best] [model: {}] , [mae {:.2f}], [mse {:.2f}]'.format(train_record['best_model_name'],\
